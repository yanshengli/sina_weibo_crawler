...
class OfficeBlogParser(BlogParser):
    def __init__(self):
...
if __name__ == '__main__':
    ...
    assistant.init()
    assistant.login()
    url = 'http://weibo.com/p/1005051059713187/weibo?count=15&is_tag=0&is_search=0&pre_page=6&profile_ftype=1&visible=0&pagebar=1&page=1'
